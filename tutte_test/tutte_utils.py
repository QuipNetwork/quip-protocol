r"""Tutte polynomial utilities and graph construction.

This module provides:
1. TuttePolynomial class for representing and manipulating Tutte polynomials
2. GraphBuilder class for incremental graph construction
3. Canonical graph structures with known Tutte polynomials
4. Tutte polynomial computation via deletion-contraction
5. Ising model generation from Tutte polynomial specifications
6. NetworkX conversion utilities
...
def compute_tutte_polynomial(g: GraphBuilder) -> TuttePolynomial:
    ...
    is_bridge_edge = is_bridge(g, edge_id)
...
if __name__ == "__main__":
    # Demo / test
    print("=== Tutte Polynomial Utilities Demo ===\n")

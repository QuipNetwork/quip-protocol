...
def test_embedding_feasibility(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            target_topology = ADVANTAGE2_SYSTEM1_TOPOLOGY
...
def precompute_embedding(config: Dict[str, Any], target_solver_name: str = "Advantage2_system1", timeout: int = 3600, try_timeout: int = 600, num_processes: Optional[int] = None) -> Dict[str, Any]:
    """
    ...
    Args:
        ...
        target_solver_name: Target solver name (default: Advantage2_system1)

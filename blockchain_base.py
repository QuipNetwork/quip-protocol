...
class BaseMiner:
    ...
    # moved to shared/quantum_proof_of_work.py: calculate_hamming_distance
    # moved to shared/quantum_proof_of_work.py: calculate_diversity
    # moved to shared/quantum_proof_of_work.py: filter_diverse_solutions

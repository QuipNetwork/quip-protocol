...
class EmbeddedTopology:
    ...
    def __init__(self, topology_name: str, solver_name: str = "Advantage2_system1"):
        """
        Create an embedded topology from a precomputed embedding.

        Args:
            topology_name: Source topology name like "Z(9,2)"
            solver_name: Target solver name (default: "Advantage2_system1")
        """
...
def create_embedded_topology(topology_name: str, solver_name: str = "Advantage2_system1") -> EmbeddedTopology:
    """
    Create an embedded topology from a precomputed embedding.

    Args:
        topology_name: Source topology like "Z(9,2)"
        solver_name: Target solver (default: "Advantage2_system1")

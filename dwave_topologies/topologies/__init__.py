...
from .advantage2_system1 import ADVANTAGE2_SYSTEM1_TOPOLOGY
from .advantage2_system4_1 import ADVANTAGE2_SYSTEM4_1_TOPOLOGY
from .json_loader import load_topology

# Default topology: Advantage2-System1 (real QPU hardware topology)
# Topology: Zephyr Z(12,4) with defects
# All miners use the same topology - no embedding needed for QPU
# Hardware topology file: dwave_topologies/topologies/advantage2_system1.json.gz
DEFAULT_TOPOLOGY = ADVANTAGE2_SYSTEM1_TOPOLOGY

...
Auto-generated by `tools/dump_solver_topology.py` on 2026-01-29 15:35:39 UTC.
...
- `advantage2_system1_11.json.gz` - Advantage2_system1.11 (default)
- `advantage2_system4_1.json.gz` - Advantage2_system4.1
...
# Load topology
topology = load_json_topology('advantage2_system1_11.json.gz')

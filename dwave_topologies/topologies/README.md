...
Auto-generated by `tools/dump_solver_topology.py` on 2026-04-15 21:36:48 UTC.
...
- `advantage2_system1.json.gz` - Advantage2_system1
...
# Load topology
topology = load_json_topology('advantage2_system1.json.gz')

...
def load_embedding(
    topology_name: str,
    solver_name: str = "Advantage2_system1_11",
    ...
    Args:
        ...
        solver_name: Target solver name (default: "Advantage2_system1_11")
...
def list_available_embeddings(solver_name: str = "Advantage2_system1_11") -> List[Tuple[str, Dict]]:
    """
...
def embedding_exists(topology_name: str, solver_name: str = "Advantage2_system1_11") -> bool:
    """

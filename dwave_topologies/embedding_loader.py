...
def load_embedding(
    topology_name: str,
    solver_name: str = "Advantage2_system1",
...
def list_available_embeddings(solver_name: str = "Advantage2_system1") -> List[Tuple[str, Dict]]:
    """
...
def embedding_exists(topology_name: str, solver_name: str = "Advantage2_system1") -> bool:
    """
